 ...
 */
class CPGRBFHK: public apear::Control {
public:
    using Matrix = Eigen::MatrixXd;
    using Vector = Eigen::VectorXd;
    typedef std::shared_ptr<CPGRBFHK> Ptr;
    typedef std::shared_ptr<const CPGRBFHK> ConstPtr;
...
private:
    ...
    nn::CPGRBFNetwork _nn; // Neural network controller
